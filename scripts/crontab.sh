...
find /var/catramms/storage/MMSWorkingAreaRepository/ -mtime +1 -type f -delete
...
find /var/catramms/storage/MMSWorkingAreaRepository/Staging/* -empty -mtime +1 -type d -delete

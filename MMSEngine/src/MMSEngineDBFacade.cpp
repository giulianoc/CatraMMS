...
MMSEngineDBFacade::MMSEngineDBFacade(
	Json::Value configuration, size_t masterDbPoolSize, size_t slaveDbPoolSize,
...
)
{
	...
	_dbConnectionPoolStatsReportPeriodInSeconds = JSONUtils::asInt(
		configuration["database"], "dbConnectionPoolStatsReportPeriodInSeconds",
		5
	);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", database->dbConnectionPoolStatsReportPeriodInSeconds: " +
		to_string(_dbConnectionPoolStatsReportPeriodInSeconds)
	);

	_ingestionWorkflowRetentionInDays = JSONUtils::asInt(
		configuration["database"], "ingestionWorkflowRetentionInDays", 30
	);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", database->ingestionWorkflowRetentionInDays: " +
		to_string(_ingestionWorkflowRetentionInDays)
	);
	_statisticRetentionInMonths = JSONUtils::asInt(
		configuration["database"], "statisticRetentionInMonths", 12
	);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", database->statisticRetentionInMonths: " +
		to_string(_statisticRetentionInMonths)
	);
	_statisticsEnabled =
		JSONUtils::asBool(configuration["database"], "statisticsEnabled", true);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", database->statisticsEnabled: " + to_string(_statisticsEnabled)
	);
	_doNotManageIngestionsOlderThanDays = JSONUtils::asInt(
		configuration["mms"], "doNotManageIngestionsOlderThanDays", 7
	);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", mms->doNotManageIngestionsOlderThanDays: " +
		to_string(_doNotManageIngestionsOlderThanDays)
	);

	_ffmpegEncoderUser =
		JSONUtils::asString(configuration["ffmpeg"], "encoderUser", "");
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", ffmpeg->encoderUser: " + _ffmpegEncoderUser
	);
	_ffmpegEncoderPassword =
		JSONUtils::asString(configuration["ffmpeg"], "encoderPassword", "");
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", ffmpeg->encoderPassword: " + "..."
	);
	_ffmpegEncoderStatusURI =
		JSONUtils::asString(configuration["ffmpeg"], "encoderStatusURI", "");
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", ffmpeg->encoderStatusURI: " + _ffmpegEncoderStatusURI
	);
	_ffmpegEncoderInfoURI =
		JSONUtils::asString(configuration["ffmpeg"], "encoderInfoURI", "");
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", ffmpeg->encoderInfoURI: " + _ffmpegEncoderInfoURI
	);
	_ffmpegEncoderInfoTimeout =
		JSONUtils::asInt(configuration["ffmpeg"], "encoderInfoTimeout", 2);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", ffmpeg->encoderInfoTimeout: " + to_string(_ffmpegEncoderInfoTimeout)
	);

	_ingestionJobsSelectPageSize = JSONUtils::asInt(
		configuration["mms"], "ingestionJobsSelectPageSize", 500
	);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", mms->ingestionJobsSelectPageSize: " +
		to_string(_ingestionJobsSelectPageSize)
	);

	_maxEncodingFailures =
		JSONUtils::asInt(configuration["encoding"], "maxEncodingFailures", 3);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", encoding->maxEncodingFailures: " + to_string(_maxEncodingFailures)
	);

	_confirmationCodeRetentionInDays = JSONUtils::asInt(
		configuration["mms"], "confirmationCodeRetentionInDays", 3
	);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", mms->confirmationCodeRetentionInDays: " +
		to_string(_confirmationCodeRetentionInDays)
	);

	_contentRetentionInMinutesDefaultValue = JSONUtils::asInt(
		configuration["mms"], "contentRetentionInMinutesDefaultValue", 1
	);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", mms->contentRetentionInMinutesDefaultValue: " +
		to_string(_contentRetentionInMinutesDefaultValue)
	);
	_contentNotTransferredRetentionInHours = JSONUtils::asInt(
		configuration["mms"], "contentNotTransferredRetentionInDays", 1
	);
	_contentNotTransferredRetentionInHours *= 24;
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", mms->contentNotTransferredRetentionInDays*24: " +
		to_string(_contentNotTransferredRetentionInHours)
	);

	_maxSecondsToWaitUpdateIngestionJobLock = JSONUtils::asInt(
		configuration["mms"]["locks"], "maxSecondsToWaitUpdateIngestionJobLock",
		1
	);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", mms->maxSecondsToWaitUpdateIngestionJobLock: " +
		to_string(_maxSecondsToWaitUpdateIngestionJobLock)
	);
	_maxSecondsToWaitUpdateEncodingJobLock = JSONUtils::asInt(
		configuration["mms"]["locks"], "maxSecondsToWaitUpdateEncodingJobLock",
		1
	);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", mms->maxSecondsToWaitUpdateEncodingJobLock: " +
		to_string(_maxSecondsToWaitUpdateEncodingJobLock)
	);
	_maxSecondsToWaitCheckIngestionLock = JSONUtils::asInt(
		configuration["mms"]["locks"], "maxSecondsToWaitCheckIngestionLock", 1
	);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", mms->maxSecondsToWaitCheckIngestionLock: " +
		to_string(_maxSecondsToWaitCheckIngestionLock)
	);
	_maxSecondsToWaitCheckEncodingJobLock = JSONUtils::asInt(
		configuration["mms"]["locks"], "maxSecondsToWaitCheckEncodingJobLock", 1
	);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", mms->maxSecondsToWaitCheckEncodingJobLock: " +
		to_string(_maxSecondsToWaitCheckEncodingJobLock)
	);
	_maxSecondsToWaitMainAndBackupLiveChunkLock = JSONUtils::asInt(
		configuration["mms"]["locks"],
		"maxSecondsToWaitMainAndBackupLiveChunkLock", 1
	);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", mms->maxSecondsToWaitMainAndBackupLiveChunkLock: " +
		to_string(_maxSecondsToWaitMainAndBackupLiveChunkLock)
	);
	_maxSecondsToWaitSetNotToBeExecutedLock = JSONUtils::asInt(
		configuration["mms"]["locks"], "maxSecondsToWaitSetNotToBeExecutedLock",
		1
	);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", mms->maxSecondsToWaitSetNotToBeExecutedLock,: " +
		to_string(_maxSecondsToWaitSetNotToBeExecutedLock)
	);

	_predefinedVideoProfilesDirectoryPath = JSONUtils::asString(
		configuration["encoding"]["predefinedProfiles"], "videoDir", ""
	);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", encoding->predefinedProfiles->videoDir: " +
		_predefinedVideoProfilesDirectoryPath
	);
	_predefinedAudioProfilesDirectoryPath = JSONUtils::asString(
		configuration["encoding"]["predefinedProfiles"], "audioDir", ""
	);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", encoding->predefinedProfiles->audioDir: " +
		_predefinedAudioProfilesDirectoryPath
	);
	_predefinedImageProfilesDirectoryPath = JSONUtils::asString(
		configuration["encoding"]["predefinedProfiles"], "imageDir", ""
	);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", encoding->predefinedProfiles->imageDir: " +
		_predefinedImageProfilesDirectoryPath
	);

	_predefinedWorkflowLibraryDirectoryPath = JSONUtils::asString(
		configuration["mms"], "predefinedWorkflowLibraryDir", ""
	);
	_logger->info(
		__FILEREF__ + "Configuration item" +
		", mms->predefinedWorkflowLibraryDir: " +
		_predefinedWorkflowLibraryDirectoryPath
	);
	...
	for (int adminEmailAddressesIndex = 0;
		 ...
		 configuration["api"]["adminEmailAddresses"].size();
		 adminEmailAddressesIndex++)
	{
		string adminEmailAddress =
			JSONUtils::asString(configuration["api"]["adminEmailAddresses"]
											 [adminEmailAddressesIndex]);
		_adminEmailAddresses.push_back(adminEmailAddress);
		_logger->info(
			__FILEREF__ + "Configuration item" +
			", mms->adminEmailAddresses[adminEmailAddressesIndex]: " +
			adminEmailAddress
		);
	}

	{
		string masterDbServer = JSONUtils::asString(
			configuration["database"]["master"], "server", ""
		);
		_logger->info(
			__FILEREF__ + "Configuration item" +
			", database->master->server: " + masterDbServer
		);
		string slaveDbServer = JSONUtils::asString(
			configuration["database"]["slave"], "server", ""
		);
		_logger->info(
			__FILEREF__ + "Configuration item" +
			", database->slave->server: " + slaveDbServer
		);
		string defaultCharacterSet = JSONUtils::asString(
			configuration["database"], "defaultCharacterSet", ""
		);
		_logger->info(
			__FILEREF__ + "Configuration item" +
			", database->defaultCharacterSet: " + defaultCharacterSet
		);
		string masterDbUsername = JSONUtils::asString(
			configuration["database"]["master"], "userName", ""
		);
		_logger->info(
			__FILEREF__ + "Configuration item" +
			", database->master->userName: " + masterDbUsername
		);
		string slaveDbUsername = JSONUtils::asString(
			configuration["database"]["slave"], "userName", ""
		);
		_logger->info(
			__FILEREF__ + "Configuration item" +
		...
		string dbPassword;
		{
			string encryptedPassword =
				JSONUtils::asString(configuration["database"], "password", "");
			dbPassword = Encrypt::opensslDecrypt(encryptedPassword);
			// dbPassword = encryptedPassword;
		}
		string dbName =
			JSONUtils::asString(configuration["database"], "dbName", "");
		_logger->info(
			__FILEREF__ + "Configuration item" + ", database->dbName: " + dbName
		);
		string selectTestingConnection = JSONUtils::asString(
			configuration["database"], "selectTestingConnection", ""
		);
		_logger->info(
			__FILEREF__ + "Configuration item" +
		...
		_mySQLMasterConnectionFactory = make_shared<MySQLConnectionFactory>(
			masterDbServer, masterDbUsername, dbPassword, dbName, reconnect,
			defaultCharacterSet, selectTestingConnection
		);
		_mySQLSlaveConnectionFactory = make_shared<MySQLConnectionFactory>(
			slaveDbServer, slaveDbUsername, dbPassword, dbName, reconnect,
			defaultCharacterSet, selectTestingConnection
		);
	...
	{
		string masterDbServer = JSONUtils::asString(
			configuration["postgres"]["master"], "server", ""
		);
		_logger->info(
			__FILEREF__ + "Configuration item" +
			", database->master->server: " + masterDbServer
		...
		string slaveDbServer = JSONUtils::asString(
			configuration["postgres"]["slave"], "server", ""
		);
		_logger->info(
			__FILEREF__ + "Configuration item" +
			", database->slave->server: " + slaveDbServer
		...
		string masterDbUsername = JSONUtils::asString(
			configuration["postgres"]["master"], "userName", ""
		);
		_logger->info(
			__FILEREF__ + "Configuration item" +
			", database->master->userName: " + masterDbUsername
		...
		string slaveDbUsername = JSONUtils::asString(
			configuration["postgres"]["slave"], "userName", ""
		);
		_logger->info(
			__FILEREF__ + "Configuration item" +
			", database->slave->userName: " + slaveDbUsername
		...
		{
			string encryptedPassword =
				JSONUtils::asString(configuration["postgres"], "password", "");
			dbPassword = Encrypt::opensslDecrypt(encryptedPassword);
			// dbPassword = encryptedPassword;
		}
		string dbName =
			JSONUtils::asString(configuration["postgres"], "dbName", "");
		_logger->info(
			__FILEREF__ + "Configuration item" + ", database->dbName: " + dbName
		);
		string selectTestingConnection = JSONUtils::asString(
			configuration["postgres"], "selectTestingConnection", ""
		);
		_logger->info(
			__FILEREF__ + "Configuration item" +
			", database->selectTestingConnection: " + selectTestingConnection
		...
		_postgresMasterConnectionFactory =
			make_shared<PostgresConnectionFactory>(
				masterDbServer, masterDbUsername, dbPassword, dbName,
				selectTestingConnection
			);
		_postgresSlaveConnectionFactory =
			make_shared<PostgresConnectionFactory>(
				slaveDbServer, slaveDbUsername, dbPassword, dbName,
				selectTestingConnection
			);
...
void MMSEngineDBFacade::resetProcessingJobsIfNeeded(string processorMMS)
{
	...
	_logger->info(
		__FILEREF__ + "resetProcessingJobsIfNeeded" +
	...
	try
	{
		...
		_logger->debug(
			__FILEREF__ + "DB connection borrow" +
			", getConnectionId: " + to_string(conn->getConnectionId())
		);

		{
			_logger->info(
				__FILEREF__ + "resetProcessingJobsIfNeeded. Locks" +
				", processorMMS: " + processorMMS
			);
			...
			_logger->info(
				__FILEREF__ +
				"@SQL statistics@ (resetProcessingJobsIfNeeded. Locks)" +
				", lastSQLCommand: " + lastSQLCommand + ", active: 0" +
				", processorMMS: " + processorMMS + ", rowsUpdated: " +
				to_string(rowsUpdated) + ", elapsed (secs): @" +
		...
		//		anyway, we will leave it here
		{
			...
			lastSQLCommand =
				"update MMS_IngestionJob set status = ? where (processorMMS is "
		...
		*/

		{
			...
			lastSQLCommand =
				"update MMS_IngestionJob set processorMMS = NULL where "
			...
			_logger->info(
				...
				", lastSQLCommand: " + lastSQLCommand + ", processorMMS: " +
				processorMMS + ", rowsUpdated: " + to_string(rowsUpdated) +
				", elapsed (secs): @" +
				to_string(chrono::duration_cast<chrono::seconds>(
							  chrono::system_clock::now() - startSql
				)
		...
		*/
		...
		_logger->debug(
			__FILEREF__ + "DB connection unborrow" +
			", getConnectionId: " + to_string(conn->getConnectionId())
		);
	...
	catch (sql::SQLException &se)
	{
		...
		_logger->error(
			__FILEREF__ + "SQL exception" +
			", lastSQLCommand: " + lastSQLCommand +
			", exceptionMessage: " + exceptionMessage + ", conn: " +
			(conn != nullptr ? to_string(conn->getConnectionId()) : "-1")
		);
	...
	{
		_logger->error(
			__FILEREF__ + "SQL exception" + ", e.what(): " + e.what() +
			", lastSQLCommand: " + lastSQLCommand + ", conn: " +
			(conn != nullptr ? to_string(conn->getConnectionId()) : "-1")
		);
...
string MMSEngineDBFacade::nextRelativePathToBeUsed(int64_t workspaceKey)
{
	...
	try
	{
...

		{
			...
			_logger->info(
				__FILEREF__ + "@SQL statistics@" + ", lastSQLCommand: " +
				lastSQLCommand + ", workspaceKey: " + to_string(workspaceKey) +
				", resultSet->rowsCount: " + to_string(resultSet->rowsCount()) +
				", elapsed (secs): @" +
				to_string(chrono::duration_cast<chrono::seconds>(
							  chrono::system_clock::now() - startSql
			...
			{
				string errorMessage =
					__FILEREF__ + "Workspace is not present/configured" +
...

		{
			...
			sprintf(
				pCurrentRelativePath, "/%03d/%03d/%03d/", currentDirLevel1,
				currentDirLevel2, currentDirLevel3
			);
...
tuple<
	int64_t, MMSEngineDBFacade::DeliveryTechnology, int, shared_ptr<Workspace>,
...
MMSEngineDBFacade::getStorageDetails(int64_t physicalPathKey, bool fromMaster)
{
	...
	try
	{
...

		{
			lastSQLCommand =
				string("") +
				"select mi.workspaceKey, mi.contentType, mi.title, "
			...
			if (resultSet->next())
			{
				...
				externalReadOnlyStorage =
					resultSet->getInt("externalReadOnlyStorage") == 0 ? false
																	  : true;
				if (resultSet->isNull("encodingProfileKey"))
					encodingProfileKey = -1;
				else
					encodingProfileKey =
						resultSet->getInt64("encodingProfileKey");
			...
			{
				string errorMessage =
					__FILEREF__ + "physicalPathKey is not present" +
					", physicalPathKey: " + to_string(physicalPathKey) +
					", lastSQLCommand: " + lastSQLCommand;
				_logger->error(errorMessage);
		...
		if (encodingProfileKey != -1)
		{
			...
			int queryParameterIndex = 1;
			preparedStatement->setInt64(
				queryParameterIndex++, encodingProfileKey
			);
			chrono::system_clock::time_point startSql =
				chrono::system_clock::now();
			shared_ptr<sql::ResultSet> resultSet(
			...
			if (resultSet->next())
			{
				deliveryTechnology = toDeliveryTechnology(
			...
			{
				string errorMessage =
					__FILEREF__ + "encodingProfileKey is not present" +
					", encodingProfileKey: " + to_string(encodingProfileKey) +
					", lastSQLCommand: " + lastSQLCommand;
				_logger->error(errorMessage);
		...
		_logger->info(
			...
			", deliveryFileName: " + deliveryFileName + ", title: " + title +
		...
		return make_tuple(
			physicalPathKey, deliveryTechnology, mmsPartitionNumber, workspace,
...
)
{
	...
	try
	{
		...
		if (encodingProfileKey != -1)
		{
			...
			_logger->info(
				__FILEREF__ + "@SQL statistics@" + ", lastSQLCommand: " +
				lastSQLCommand + ", mediaItemKey: " + to_string(mediaItemKey) +
				", encodingProfileKey: " + to_string(encodingProfileKey) +
				", resultSet->rowsCount: " + to_string(resultSet->rowsCount()) +
				", elapsed (secs): @" +
				to_string(chrono::duration_cast<chrono::seconds>(
...

			{
				...
				_logger->info(
					...
					", encodingProfileKey: " + to_string(encodingProfileKey) +
					", resultSet->rowsCount: " +
					to_string(resultSet->rowsCount()) + ", elapsed (secs): @" +
					to_string(chrono::duration_cast<chrono::seconds>(
								  chrono::system_clock::now() - startSql
					)
								  .count()) +
				...
				else
				{
					string errorMessage = __FILEREF__ +
										  "encodingProfileKey is not present" +
										  ", encodingProfileKey: " +
		...
		else
		{
			tuple<int64_t, int, string, string, uint64_t, bool, int64_t>
				sourcePhysicalPathDetails = getSourcePhysicalPath(
					mediaItemKey, warningIfMissing, fromMaster
				);
			tie(physicalPathKey, mmsPartitionNumber, relativePath, fileName,
				sizeInBytes, externalReadOnlyStorage, ignore) =
			...
			if (resultSet->next())
			{
				...
				if (contentType == ContentType::Video ||
					contentType == ContentType::Audio)
					deliveryTechnology =
						DeliveryTechnology::DownloadAndStreaming;
				else
					deliveryTechnology = DeliveryTechnology::Download;
			}
	...
	catch (MediaItemKeyNotFound &e)
	{
		if (warningIfMissing)
			_logger->warn(
				__FILEREF__ + "MediaItemKeyNotFound" + ", e.what(): " +
				e.what() + ", lastSQLCommand: " + lastSQLCommand + ", conn: " +
				(conn != nullptr ? to_string(conn->getConnectionId()) : "-1")
			);
		else
			_logger->error(
	...
	{
		_logger->error(
			__FILEREF__ + "runtime_error" + ", e.what(): " + e.what() +
			", lastSQLCommand: " + lastSQLCommand + ", conn: " +
			(conn != nullptr ? to_string(conn->getConnectionId()) : "-1")
		);
...
)
{
	...
	try
	{
		...
		{
			lastSQLCommand =
				"select mi.workspaceKey, mi.contentType, "
			...
			while (resultSet->next())
			{
				...
				if (encodingProfileKey != -1)
				{
					...
					shared_ptr<sql::PreparedStatement>
						technologyPreparedStatement(
							conn->_sqlConnection->prepareStatement(
								lastSQLCommand
							)
						);
					int queryParameterIndex = 1;
					technologyPreparedStatement->setInt64(
						queryParameterIndex++, encodingProfileKey
					);
					chrono::system_clock::time_point startSql =
						chrono::system_clock::now();
					shared_ptr<sql::ResultSet> technologyResultSet(
						technologyPreparedStatement->executeQuery()
					);
					_logger->info(
						__FILEREF__ + "@SQL statistics@" +
						", lastSQLCommand: " + lastSQLCommand +
						", encodingProfileKey: " +
						to_string(encodingProfileKey) +
						", technologyResultSet->rowsCount: " +
						to_string(technologyResultSet->rowsCount()) +
						", elapsed (secs): @" +
						to_string(chrono::duration_cast<chrono::seconds>(
									  chrono::system_clock::now() - startSql
						)
					...
					{
						deliveryTechnology = toDeliveryTechnology(
							technologyResultSet->getString("deliveryTechnology")
						);
					}
					else
					{
				...
				tuple<
					MMSEngineDBFacade::DeliveryTechnology, int, string, string,
					string, int64_t, bool>
					storageDetails = make_tuple(
						deliveryTechnology, mmsPartitionNumber,
						workspace->_directoryName, relativePath, fileName,
						sizeInBytes, externalReadOnlyStorage
					);
...

		{
			...
			if (clientIPAddress == "")
				preparedStatement->setNull(
					queryParameterIndex++, sql::DataType::VARCHAR
				);
			else
				preparedStatement->setString(
					queryParameterIndex++, clientIPAddress
				);
			...
			_logger->info(
				__FILEREF__ + "@SQL statistics@" + ", lastSQLCommand: " +
				lastSQLCommand + ", userKey: " + to_string(userKey) +
				", clientIPAddress: " + clientIPAddress + ", contentType: " +
				contentType + ", contentKey: " + to_string(contentKey) +
...
)
{
	...
	try
	{
...

		{
			...
			int queryParameterIndex = 1;
			preparedStatement->setInt64(
				queryParameterIndex++, deliveryAuthorizationKey
			);
			chrono::system_clock::time_point startSql =
				chrono::system_clock::now();
			shared_ptr<sql::ResultSet> resultSet(
			...
			_logger->info(
				__FILEREF__ + "@SQL statistics@" + ", lastSQLCommand: " +
				lastSQLCommand + ", deliveryAuthorizationKey: " +
				to_string(deliveryAuthorizationKey) +
				", resultSet->rowsCount: " + to_string(resultSet->rowsCount()) +
				", elapsed (secs): @" +
				to_string(chrono::duration_cast<chrono::seconds>(
							  chrono::system_clock::now() - startSql
			...
			if (resultSet->next())
			{
				...
				int currentRetriesNumber =
					resultSet->getInt("currentRetriesNumber");
				int maxRetries = resultSet->getInt("maxRetries");
				int timeToLiveAvailable =
					resultSet->getInt("timeToLiveAvailable");

				if (contentURI != deliveryURI)
				{
					string errorMessage =
						__FILEREF__ +
						"contentURI and deliveryURI are different" +
				...
				{
					string errorMessage =
						__FILEREF__ + "maxRetries is already reached" +
						", currentRetriesNumber: " +
						to_string(currentRetriesNumber) +
						", maxRetries: " + to_string(maxRetries) +
						", lastSQLCommand: " + lastSQLCommand;
					_logger->error(errorMessage);
			...
			{
				string errorMessage = __FILEREF__ +
									  "deliveryAuthorizationKey not found" +
		...
		if (authorizationOK)
		{
			...
			_logger->info(
				__FILEREF__ + "@SQL statistics@" + ", lastSQLCommand: " +
				lastSQLCommand + ", deliveryAuthorizationKey: " +
				to_string(deliveryAuthorizationKey) + ", elapsed (secs): @" +
				to_string(chrono::duration_cast<chrono::seconds>(
							  chrono::system_clock::now() - startSql
				)
							  .count()) +
...
void MMSEngineDBFacade::retentionOfDeliveryAuthorization()
{
	...
	try
	{
...

		{
			...
			while (moreRowsToBeRemoved)
			{
				try
				{
					...
					preparedStatement->setInt(
						queryParameterIndex++, maxToBeRemoved
					);
				...
				catch (sql::SQLException &se)
				{
					...
					_logger->error(
						__FILEREF__ + "SQL exception" +
						", lastSQLCommand: " + lastSQLCommand +
						", se.what(): " + se.what() + ", conn: " +
						(conn != nullptr ? to_string(conn->getConnectionId())
										 : "-1")
					);
					...
					_logger->info(
						__FILEREF__ +
						"retentionOfDeliveryAuthorization failed, " +
						"waiting before to try again" +
						", currentRetriesOnError: " +
						to_string(currentRetriesOnError) +
						", maxRetriesOnError: " + to_string(maxRetriesOnError) +
						", secondsBetweenRetries: " +
						to_string(secondsBetweenRetries)
					);
			...
			_logger->info(
				__FILEREF__ + "Deletion obsolete DeliveryAuthorization" +
...
int64_t MMSEngineDBFacade::getLastInsertId(shared_ptr<MySQLConnection> conn)
{
	...
	try
	{
		...
		_logger->info(
			__FILEREF__ + "@SQL statistics@" +
			", lastSQLCommand: " + lastSQLCommand + ", resultSet->rowsCount: " +
			to_string(resultSet->rowsCount()) + ", elapsed (secs): @" +
			to_string(chrono::duration_cast<chrono::seconds>(
						  chrono::system_clock::now() - startSql
			)
	...
	catch (sql::SQLException &se)
	{
		...
		_logger->error(
			__FILEREF__ + "SQL exception" + ", lastSQLCommand: " +
			lastSQLCommand + ", exceptionMessage: " + exceptionMessage
		);
	...
	try
	{
		...
		*/
		...
		string today_yyyy_mm_dd;
		{
			...
			sprintf(
				strDateTime, "%04d-%02d-%02d", tmDateTime.tm_year + 1900,
...

		{
			...
			int queryParameterIndex = 1;
			preparedStatement->setString(
				queryParameterIndex++, today_yyyy_mm_dd
			);
			preparedStatement->setString(
				queryParameterIndex++,
			...
			int rowsUpdated = preparedStatement->executeUpdate();
			_logger->info(
				__FILEREF__ + "@SQL statistics@ (oncePerDayExecution)" +
				", lastSQLCommand: " + lastSQLCommand +
...
MMSEngineDBFacade::DeliveryTechnology
MMSEngineDBFacade::fileFormatToDeliveryTechnology(string fileFormat)
{
	MMSEngineDBFacade::DeliveryTechnology deliveryTechnology;
	...
	if (fileFormatLowerCase == "mp4" || fileFormatLowerCase == "mkv" ||
		fileFormatLowerCase == "mov" || fileFormatLowerCase == "webm")
		deliveryTechnology =
			MMSEngineDBFacade::DeliveryTechnology::DownloadAndStreaming;
	else if (fileFormatLowerCase == "hls" || fileFormatLowerCase == "m3u8" ||
			 fileFormatLowerCase == "dash")
		deliveryTechnology =
			MMSEngineDBFacade::DeliveryTechnology::HTTPStreaming;
	else if (fileFormatLowerCase == "ts" || fileFormatLowerCase == "mts" ||

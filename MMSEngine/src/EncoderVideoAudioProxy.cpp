...
bool EncoderVideoAudioProxy::overlayImageOnVideo_through_ffmpeg()
{
	...
	try
	{
		...
		if (_encodingItem->_encoderKey == -1)
		{
			...
			Json::Value overlayContentResponse = MMSCURL::httpPostStringAndGetJson(
				_encodingItem->_ingestionJobKey,
				ffmpegEncoderURL,
				_ffmpegEncoderTimeoutInSeconds,
				_ffmpegEncoderUser,
...
bool EncoderVideoAudioProxy::overlayTextOnVideo_through_ffmpeg()
{
	...
	try
	{
		...
		if (_encodingItem->_encoderKey == -1)
		{
			...
			Json::Value overlayTextContentResponse = MMSCURL::httpPostStringAndGetJson(
				_encodingItem->_ingestionJobKey,
				ffmpegEncoderURL,
				_ffmpegEncoderTimeoutInSeconds,
				_ffmpegEncoderUser,
...
bool EncoderVideoAudioProxy::videoSpeed()
{
    ...
    killedByUser = videoSpeed_through_ffmpeg();
	if (killedByUser)
	{
		string errorMessage = __FILEREF__ + "Encoding killed by the User"
			+ ", _proxyIdentifier: " + to_string(_proxyIdentifier)
...
bool EncoderVideoAudioProxy::videoSpeed_through_ffmpeg()
{
	...
	try
	{
		...
		if (_encodingItem->_encoderKey == -1)
		{
            ...
            string body;
            {
				...
				videoSpeedMetadata["externalEncoder"] = _currentUsedFFMpegExternalEncoder;
				...
				videoSpeedMetadata["ingestedParametersRoot"] = _encodingItem->_ingestedParametersRoot;
				videoSpeedMetadata["encodingParametersRoot"] = _encodingItem->_encodingParametersRoot;

				body = JSONUtils::toString(videoSpeedMetadata);
            }
            
			Json::Value videoSpeedContentResponse = MMSCURL::httpPostStringAndGetJson(
				_encodingItem->_ingestionJobKey,
				ffmpegEncoderURL,
				_ffmpegEncoderTimeoutInSeconds,
				_ffmpegEncoderUser,
...
bool EncoderVideoAudioProxy::generateFrames_through_ffmpeg()
{
	...
	try
	{
		...
		if (_encodingItem->_encoderKey == -1) // || _encodingItem->_stagingEncodedAssetPathName == "")
		{
			...
			Json::Value generateFramesContentResponse = MMSCURL::httpPostStringAndGetJson(
				_encodingItem->_ingestionJobKey,
				ffmpegEncoderURL,
				_ffmpegEncoderTimeoutInSeconds,
				_ffmpegEncoderUser,
...
bool EncoderVideoAudioProxy::slideShow()
{
	...
	killedByUser = slideShow_through_ffmpeg();
	if (killedByUser)
	{
		string errorMessage = __FILEREF__ + "Encoding killed by the User"
			+ ", _proxyIdentifier: " + to_string(_proxyIdentifier)
...
bool EncoderVideoAudioProxy::slideShow_through_ffmpeg()
{
	...
	try
	{
		...
		if (_encodingItem->_encoderKey == -1)
		{
            ...
            string body;
            {
				...
				slideShowMedatada["externalEncoder"] = _currentUsedFFMpegExternalEncoder;
				slideShowMedatada["encodingParametersRoot"] = _encodingItem->_encodingParametersRoot;
				slideShowMedatada["ingestedParametersRoot"] = _encodingItem->_ingestedParametersRoot;

				body = JSONUtils::toString(slideShowMedatada);
            }

			Json::Value slideShowContentResponse = MMSCURL::httpPostStringAndGetJson(
				_encodingItem->_ingestionJobKey,
				ffmpegEncoderURL,
				_ffmpegEncoderTimeoutInSeconds,
				_ffmpegEncoderUser,

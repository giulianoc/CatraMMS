...
public class IngestionWorkflows extends Workspace implements Serializable {
    ...
    public void beginChanged()
    {
        ...
        if (begin.getTime() >= end.getTime())
        {
            ...
            FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_ERROR,
                    "Ingestion Workflows", "BeginDate cannot be later the EndDate");
    ...
    public String getIngestionWorkflowStyleClass(int rowId)
    {
        String styleClass = "";

        String status = getStatus(ingestionWorkflowsList.get(rowId));

...
void EncoderCPUUsageThread::newCPUUsageAvailable(uint16_t& cpuUsage) const
{
	if (_encoderKey < 0)
	{
	...
	{
		SPDLOG_ERROR("The 'updateCPUStatsPassword' configuration item is not valid and CPU stats is not sent to API MMS Server"

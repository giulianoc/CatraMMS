...
class MMSCURL
{
  ...
  public:
	...
	static string httpGet(
		...
		string basicAuthenticationPassword, vector<string> otherHeaders, int maxRetryNumber = 0, int secondsToWaitBeforeToRetry = 15
	);
	...
	static pair<string, string> httpPostString(
		...
		vector<string> otherHeaders, int maxRetryNumber = 0, int secondsToWaitBeforeToRetry = 15
	);
	...
	static string httpPostFile(
		shared_ptr<spdlog::logger> logger, int64_t ingestionJobKey, string url, long timeoutInSeconds, string basicAuthenticationUser,
		string basicAuthenticationPassword, string pathFileName, int64_t fileSizeInBytes, int maxRetryNumber = 0, int secondsToWaitBeforeToRetry = 15,
	...
	static string httpPostFileByFormData(
		shared_ptr<spdlog::logger> logger, int64_t ingestionJobKey, string url, vector<pair<string, string>> formData, long timeoutInSeconds,
		string pathFileName, int64_t fileSizeInBytes, string mediaContentType, int maxRetryNumber = 0, int secondsToWaitBeforeToRetry = 15,
		int64_t contentRangeStart = -1, int64_t contentRangeEnd_Excluded = -1
	);
  ...
  private:
	...
	static string httpPostPutFileByFormData(
		shared_ptr<spdlog::logger> logger, int64_t ingestionJobKey, string url, vector<pair<string, string>> formData,
		string requestType, // POST or PUT
		long timeoutInSeconds, string pathFileName, int64_t fileSizeInBytes, string mediaContentType, int maxRetryNumber,

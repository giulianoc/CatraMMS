...
echo ""
printf "${RED}"
echo "git push https://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@github.com/giulianoc/CatraMMS.git"
printf "${NC}"
git push https://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@github.com/giulianoc/CatraMMS.git

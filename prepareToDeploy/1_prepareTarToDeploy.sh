...
echo ""
printf "${RED}"
echo "git push https://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@github.com/giulianoc/CatraMMS.git"
printf "${NC}"
git push https://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@github.com/giulianoc/CatraMMS.git

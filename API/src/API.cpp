...
)
{
    ...
    else if (method == "addYouTubeDetails")
    {
        addYouTubeDetails(request, userKey, queryParameters, requestBody);
    }
    else if (method == "modifyYouTubeDetails")
    {
        modifyYouTubeDetails(request, userKey, queryParameters, requestBody);
    }
